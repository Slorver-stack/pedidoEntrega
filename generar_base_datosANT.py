...
try:
    conn = mysql.connector.connect(
           host='slorver.mysql.pythonanywhere-services.com',
           user='slorver',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `slorver$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `slorver$pedidoEntrega`;")

cursor.execute("USE `slorver$pedidoEntrega`;")
...
cursor.execute('select * from slorver$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from slorver$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
